...
-   it goes from only porviding the overall price_mean and providing a breakdown of color and clarity as well as price means for the color and clarity
...
df_q4 <-
  ...
  summarize(
    depth_sd = sd(depth, na.rm = TRUE),    #na.rm excludes anything that is NA
...
**Observations**: - the ideal diamond would have been ecpected to have the highest price, but the premium and then fair did. There is very high covariance – this means that other qualities likely account for the cost.
