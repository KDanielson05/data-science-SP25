...
### **q1** Run the following code and pay attention to the column names. Open the downloaded Excel sheet and compare. Why are the column names so weird?
...
-   Based on reading the Excel sheet, why do you think the columns are so weird?
    -   There is a lot of spacing above many of the column names or other random text
...
### **q3** Change the column names and types.
...
### **q4** I have already provided the `while` loop below; fill in `vars_lagged` with the names of the columns where cell values are *implicit*.
