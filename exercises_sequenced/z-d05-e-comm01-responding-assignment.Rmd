...
-   Is the bolded response **active** or **passive**? Why?
    -   The bolded response is an active response as it's engaging directly in what the colleague is saying.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   This is a constructive statement – it's engaging in a positive way with the speaker.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   This statement makes me feel overall positive emotions
...
-   Is the bolded response **active** or **passive**? Why?
    -   Active repsonse as it recognizes what the person says
-   Is the bolded response **constructive** or **destructive**? Why?
    -   Destructive as it just dismisses the statement after recognizing it and does not engage.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
...
-   Is the bolded response **active** or **passive**? Why?
    -   Passive as it's a departure from the topic
-   Is the bolded response **constructive** or **destructive**? Why?
    -   This feels more neutral
