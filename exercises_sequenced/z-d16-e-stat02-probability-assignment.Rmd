...
$$F_X(A) \equiv \sum \frac{\text{Cases in set }A}{\text{Total Cases in }X}.$$ For the example above, we have
...
-   What value of `fr` did you predict?
    -   I preducted something around 50%
-   Did your prediction match your calculation?
    -   This was a higher value than I expected – this is due to the randomness of z
...
-   What was your `fr` prediction in **q1**? How does `p0` compare?
    -   It aligns with what the fr in q1 was going towards
...
[2] Technically these samples must be drawn *independently and identically distributed*, shortened to iid.
