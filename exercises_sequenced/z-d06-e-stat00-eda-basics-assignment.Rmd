...
**Observations**: This hypothesis was incorrect as there was the largest
number of ideal diamonds compared to other cuts.
...
**Observations**: This is not a good representation as there is too much
overplotting and it cannot be distinguised what is really going on.
...
**Observations**: The hypothesis is not supported – this is a much
better graph and shows that the median of ideal cut diamond prices tend
to actually be less expensive.
...
**Observations**: The hypothesis is supported. The median on ideal
diamond carats is lower while that with lower quality (ex. fair) tends
to have a higher median carat.
...
-   **We used knowledge about the real world to make sense of the
    data.**
