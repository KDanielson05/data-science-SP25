...
df_sample %>%
  summarize(
    ...
    price_sd = sd(price),
    n_samp = n(),
    price_lo = price_mean - q * price_sd / sqrt(n_samp),
    price_hi = price_mean + q * price_sd / sqrt(n_samp)
  )
...
-   Can you reject the null hypothesis **H_0**?
    -   cannot reject as not everything is lower
-   How does this affect your decision?
    -   I will not buy the diamonds
...
-   Did you reject the null hypothesis in q1?
    -   did not reject the null hypothesis in q1
-   What is the actual truth?
    -   the mean price is lower than 1700
-   What decision did you make?
    -   it was technically the incorrect decision, but we learned nothing from the sample so we could not make another decision
...
df_population %>% 
  summarize(
    proportion = mean((cut == "Premium") | (cut == "Ideal"))
  )
```
...
-   Did you reject the null hypothesis in q2?
    -   Yes I did reject the null hypothesis
-   What is the actual truth?
    -   that the proportion of high-cut diamonds is greater than 50
-   What decision did you make?
    -   the correct one
