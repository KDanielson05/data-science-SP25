...
cut looks at the quality of the cut

color is the diamond color D( (best) abd J (worst)

clarity us a measurement of how clear the diamond is
...
the diamonds data set has variables carat, cut, color, clarity, depth,
...
-   The minimum price for diamonds is \$326, but it can go as high as
    \$18823
-   The clarity decreases by order of thousands for clearer diamonds
-   "table" does not appear to have values
...
df_q5 <- # <- is an assignment operator, I can also use "=" to assign a variable
