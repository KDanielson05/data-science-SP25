...
-   It assumes a 1:1 relation of the data, and that there is a relation to begin with in the first place

-   the displ does not necessarily correlate to the hwy – you can have the same displ and multiple hwy values
...
-   the raw data shows a lot of different peaks that occur within the data – shows short-term patterns

-   the smoothed data shows the overall trends of the data, but does not show the large variance – shows long-term trends
